...
function WebsiteChatPage() {
  ...
  const websiteAnalysis = location.state?.websiteAnalysis;

  const [messages, setMessages] = useState([
    {
      id: 1,
      type: "ai",
      text: "👋 Hi! I'm your AI Website Privacy Assistant. I've reviewed the site you analyzed. Ask me about tracking, sharing, or clauses.",
      timestamp: new Date(),
    },
  ]);
    ...
    try {
      ...
      if (websiteAnalysis) {
        payload.context = {
          ...
          riskScore: websiteAnalysis?.riskScore,
          riskLevel: websiteAnalysis?.riskLevel,
          risks: websiteAnalysis?.risks?.slice(0, 5),
  ...
  return (
    <DashboardLayout>
      <PageHeader
        title="AI Website Privacy Assistant"
        subtitle="Ask questions about the analyzed website"
      />
      ...
      <div className="h-[70vh] flex flex-col rounded-[3rem] border border-white/10 bg-white/3 backdrop-blur-3xl overflow-hidden">
        ...
        {messages.length === 1 && !loading && (
          <div className="px-8 pb-4">
            <p className="text-xs uppercase tracking-wider text-white/40 mb-3">Suggested Questions</p>
